...
- (void)drawRect:(CGRect)rect
{
    ...
    UIBezierPath *backPath = [UIBezierPath bezierPathWithArcCenter:(CGPoint){rect.size.width * 0.5, rect.size.height * 0.5} radius:radius startAngle:0 endAngle:M_PI * 2 clockwise:YES];
    backPath.lineWidth = KHWCircleLineWidth;
    [RGB(211, 211, 211) setStroke];
    [backPath stroke];
